...
if(empty($nama)) die('illegal access, system aborted');
for($i=1;$i<=20;++$i){
...
<div class="w3-container">
    <div class="w3-card-4">
      ...
      <div class="s12 w3-padding">
        <p>Hai, <b><?php echo strtoupper($nama);?></b> berikut adalah interprestasi dari test PAPI Kostick yang sudah Anda isi:</p>
...
?>
        ...
        <div class="w3-container">
        <style>#body {overflow: hidden;margin: 0;font-size: 14px;font-family: "Helvetica Neue", Helvetica;}#chart {position:relative;top:50px;left:100px;margin-bottom:50px;}</style>
        ...
        <div class="w3-padding">
            <center><div id="qrcode" class="pull-right"></div></center>
            <h3>&nbsp;</h3>
        </div>
        </div>
...
<div class="w3-bottom">
	...
	$(document).ready(function(){
		var qrcode = new QRCode("qrcode", {
            text: "https://psycho.cahyadsn.com/papi/v4/<?php echo "final.php?gen=".date('YmdHis',strtotime($created_at)).$id;?>",
			width: 128,
			height: 128,
			colorDark : "#000000",
			colorLight : "#ffffff",
